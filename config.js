...
global.namebot = '𝗥𝗶𝗺𝘂𝗿𝘂𝗕𝗼𝘁' //Nama Bot
global.nameown = 'Ray' // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['62895627514070', 'Ray🎐', true] //Ganti jd nomormu sama Namamu
...
/*============== WATERMARK ==============*/
global.wm = '                「 ѕαkurαвσt 汉  」' //Main Watermark
global.wm2 = '© ᴄʀᴇᴀᴛᴇᴅ ʙʏ ʀᴀʏ'
global.wm3 = '⫹⫺ sᴀᴋᴜʀᴀʙᴏᴛ'
global.botdate = `⫹⫺ 𝗛𝗮𝗿𝗶: ${week} ${date}`
global.bottime = `𝗪𝗮𝗸𝘁𝘂 : ${wktuwib}`
global.titlebot = '𝗥𝘂𝗺𝗶𝗻𝗮𝘀-𝗠𝗗'
...
/*============== LOGO ==============*/
global.thumb = 'https://telegra.ph/file/34f7c3927aece934deb51.jpg' //Main Thumbnail
